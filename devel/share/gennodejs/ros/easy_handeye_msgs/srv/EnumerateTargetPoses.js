...
class EnumerateTargetPosesRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EnumerateTargetPosesRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EnumerateTargetPosesRequest
    let len;
    let data = new EnumerateTargetPosesRequest(null);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'easy_handeye_msgs/EnumerateTargetPosesRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EnumerateTargetPosesRequest(null);
    return resolved;
    }
};

class EnumerateTargetPosesResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EnumerateTargetPosesResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EnumerateTargetPosesResponse
    let len;
    let data = new EnumerateTargetPosesResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EnumerateTargetPosesResponse(null);
...
module.exports = {
  Request: EnumerateTargetPosesRequest,
  Response: EnumerateTargetPosesResponse,
  md5sum() { return '80d5a3ee3a473035f3acfbf477197597'; },
  datatype() { return 'easy_handeye_msgs/EnumerateTargetPoses'; }
};
