...
class SetModeActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SetModeResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SetModeResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetModeActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = SetModeResult.Resolve(msg.result)
    }
    else {
      resolved.result = new SetModeResult()
    }
...
module.exports = SetModeActionResult;
