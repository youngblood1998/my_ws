...
(cl:defmethod cl:initialize-instance :after ((m <ComputeCalibration-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ComputeCalibration-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name easy_handeye_msgs-srv:<ComputeCalibration-request> is deprecated: use easy_handeye_msgs-srv:ComputeCalibration-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ComputeCalibration-request>)))
  ...
  "easy_handeye_msgs/ComputeCalibrationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComputeCalibration-request)))
  "Returns string type for a service object of type 'ComputeCalibration-request"
  "easy_handeye_msgs/ComputeCalibrationRequest")
...
(cl:defclass <ComputeCalibration-response> (roslisp-msg-protocol:ros-message)
  ((valid
   ...
   (calibration
    :reader calibration
    :initarg :calibration
    :type easy_handeye_msgs-msg:HandeyeCalibration
    :initform (cl:make-instance 'easy_handeye_msgs-msg:HandeyeCalibration)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ComputeCalibration-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ComputeCalibration-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name easy_handeye_msgs-srv:<ComputeCalibration-response> is deprecated: use easy_handeye_msgs-srv:ComputeCalibration-response instead.")))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <ComputeCalibration-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader easy_handeye_msgs-srv:valid-val is deprecated.  Use easy_handeye_msgs-srv:valid instead.")
  (valid m))

(cl:ensure-generic-function 'calibration-val :lambda-list '(m))
(cl:defmethod calibration-val ((m <ComputeCalibration-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader easy_handeye_msgs-srv:calibration-val is deprecated.  Use easy_handeye_msgs-srv:calibration instead.")
  (calibration m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ComputeCalibration-response>)))
  ...
  "easy_handeye_msgs/ComputeCalibrationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComputeCalibration-response)))
  "Returns string type for a service object of type 'ComputeCalibration-response"
  "easy_handeye_msgs/ComputeCalibrationResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComputeCalibration)))
  ...
  "easy_handeye_msgs/ComputeCalibration")