...
"""autogenerated by genpy from easy_handeye_msgs/ComputeCalibrationRequest.msg. Do not edit."""
import codecs
import sys
...
class ComputeCalibrationRequest(genpy.Message):
  ...
  _type = "easy_handeye_msgs/ComputeCalibrationRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from easy_handeye_msgs/ComputeCalibrationResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ComputeCalibrationResponse(genpy.Message):
  _md5sum = "6afc2cd822d24a09561ea7009e409ca0"
  _type = "easy_handeye_msgs/ComputeCalibrationResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['bool','easy_handeye_msgs/HandeyeCalibration']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.calibration is None:
        self.calibration = easy_handeye_msgs.msg.HandeyeCalibration()
    else:
      self.valid = False
      self.calibration = easy_handeye_msgs.msg.HandeyeCalibration()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2B3I().pack(_x.valid, _x.calibration.eye_on_hand, _x.calibration.transform.header.seq, _x.calibration.transform.header.stamp.secs, _x.calibration.transform.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.valid, _x.calibration.eye_on_hand, _x.calibration.transform.header.seq, _x.calibration.transform.header.stamp.secs, _x.calibration.transform.header.stamp.nsecs,) = _get_struct_2B3I().unpack(str[start:end])
...
class ComputeCalibration(object):
  _type          = 'easy_handeye_msgs/ComputeCalibration'
  _md5sum = '6afc2cd822d24a09561ea7009e409ca0'
