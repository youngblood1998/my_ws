...
class Image_converter:
	...
	self.image_sub = message_filters.Subscriber('/head_mount_kinect2/rgb/image_raw',Image,queue_size=1)
	self.depth_sub = message_filters.Subscriber('/head_mount_kinect2/depth_registered/points', PointCloud2, queue_size=1)
	sync = message_filters.ApproximateTimeSynchronizer([self.image_sub, self.depth_sub],10,0.1,allow_headerless=True)
