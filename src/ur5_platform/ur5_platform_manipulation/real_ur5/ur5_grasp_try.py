...
INIT_JOINT = [2.1735377311706543, -1.228325668965475, 1.5799808502197266, -2.1139591375934046, -2.338982407246725, -0.8367660681353968]
...
class Gpd_grasp:
    ...
    def callback(self):
        orientation1 = oritation(0.640525073018,-0.253622146648,0.70027518226,0.187131255208)
        position1 = Point()
        position1.x = -0.0164339015727
        position1.y = -0.0145130134395
        position1.z = 0.317959021286
        ...
        # matrix = np.dot(rotate1,np.dot(rotate2,np.dot(matrix,rotate3)))
