...
class SetPayloadRequest(genpy.Message):
  _md5sum = "3fb05883ed2c985331004a717cd96a56"
...
float64 y
float64 z"""
  __slots__ = ['payload','center_of_gravity']
  _slot_types = ['float32','geometry_msgs/Vector3']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.center_of_gravity is None:
        self.center_of_gravity = geometry_msgs.msg.Vector3()
    else:
      self.payload = 0.
      self.center_of_gravity = geometry_msgs.msg.Vector3()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_f3d().pack(_x.payload, _x.center_of_gravity.x, _x.center_of_gravity.y, _x.center_of_gravity.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.payload, _x.center_of_gravity.x, _x.center_of_gravity.y, _x.center_of_gravity.z,) = _get_struct_f3d().unpack(str[start:end])
      return self
...
class SetPayload(object):
  ...
  _md5sum = '98b2f6ade618936d2c8998562272cbf5'
