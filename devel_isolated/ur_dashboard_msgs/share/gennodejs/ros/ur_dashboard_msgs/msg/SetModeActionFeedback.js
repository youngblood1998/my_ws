...
class SetModeActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SetModeFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetModeActionFeedback(null);
    ...
    data.feedback = SetModeFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetModeActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SetModeFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SetModeFeedback()
    }
...
module.exports = SetModeActionFeedback;
