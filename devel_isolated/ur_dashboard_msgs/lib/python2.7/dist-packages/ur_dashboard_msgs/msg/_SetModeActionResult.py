...
"""autogenerated by genpy from ur_dashboard_msgs/SetModeActionResult.msg. Do not edit."""
import codecs
import sys
...
class SetModeActionResult(genpy.Message):
  _md5sum = "1471476fb0fc7d1ce25819ffcafc3f6d"
  _type = "ur_dashboard_msgs/SetModeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ur_dashboard_msgs/SetModeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetModeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ur_dashboard_msgs.msg.SetModeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ur_dashboard_msgs.msg.SetModeResult()
