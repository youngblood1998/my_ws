...
"""autogenerated by genpy from ur_dashboard_msgs/SetModeActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SetModeActionFeedback(genpy.Message):
  _md5sum = "831678737b3029b95af045136cbfc40f"
  _type = "ur_dashboard_msgs/SetModeActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ur_dashboard_msgs/SetModeFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetModeActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ur_dashboard_msgs.msg.SetModeFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ur_dashboard_msgs.msg.SetModeFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2b().pack(_x.feedback.current_robot_mode, _x.feedback.current_safety_mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.current_robot_mode, _x.feedback.current_safety_mode,) = _get_struct_2b().unpack(str[start:end])
      return self
